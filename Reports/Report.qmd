...
Ultimately, all three methods perform very similar (@tbl-rmse). I plot the relationship between predicted and observed turnout in @fig-pred-turnout to demonstrate the relaitvely weak linear predictive power.
